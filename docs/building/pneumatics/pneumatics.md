...
![Diagram of a solenoid and pneumatic wire](image-2.png)
...
![Diagram of V5 pneumatic piston](image-3.png)
...
![The Pressure Regulator, Pressure Gauge, airflow regulator, L-piece, T-piece, and straight piece.](image-4.png)
...
![A solenoid with arrows pointing to the screws and halves. And an image saying "an incel (not me) figured this out btw"](image-5.png)
