...
![1-Post Standoff Retainer with Bearing Flat](image-2.png)
/// caption
A V3 bearing.
///

![A right view of a drivetrain with the exterior C-channel removed, showing gearing and bearings](image-1.png)
/// caption
...
**Mounting your cross braces:** You can mount your cross braces with either standoffs and 2 screws or lock nuts and spacers with a nut and screw. Standoffs are by far easier to take off but you have to [Loctite](/building/building-habits/building-habits) one side for the screws to not come loose. Lock nuts and spacers are more secure but are a PAIN to take off requiring a lot more skill and effort. (personally I use standoffs).
...
**[Boxing your drive](/building/building-habits/building-habits):** Use .875" spacers on the corners of your drive.
...
![A top view CAD screenshot of drive gears in the C-channel enclosure](image-3.png)
/// caption
Drive gears (green) and an idler gear (red). Notice the gap from the side of the drive.
///

### Wheels
Mount the wheels last. The wheels will be on [screw joints](/building/building-habits/building-habits) using 2.5" screws. The gears/wheels need circle inserts. I space the gears .031" off the wheel. Make sure to use 2 screws and nylon lock nuts to secure the wheels to the gear. I mount the wheels/gear assembly at least .62" off the channel.

![A V5 wheel](image-4.png)
